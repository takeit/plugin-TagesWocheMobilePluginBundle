...
```
    php application/console plugins:install "newscoop/tageswoche-mobile-plugin-bundle" --env=prod # installs this plugin
```
...
```
    php application/console plugins:remove "newscoop/newscoop/tageswoche-mobile-plugin-bundle" --env=prod # removes this plugin
```
...
```
    php application/console plugins:update "newscoop/newscoop/tageswoche-mobile-plugin-bundle" --env=prod # updates this plugin
```
